    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($amenity) {
                return view('dashboard.amenities.datatable.action', ['amenity' => $amenity]);
            })
            ->addColumn('icon', function ($amenity) {
                return view('dashboard.amenities.datatable.icon', ['amenity' => $amenity]);
            })
            ->addColumn('status', function ($amenity) {
                return view('dashboard.amenities.datatable.status', ['amenity' => $amenity]);
            })
            ->setRowId('id');
    }
