                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <select name="package_type" class="form-control">
                                                ...
                                                <option value="free" @selected(old('package_type') == 'free')>Free</option>
                                                <option value="paid" @selected(old('package_type') == 'paid')>Paid</option>
                                            </select>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="number_of_featured_listings"
                                                   class="form-control"
                                                   placeholder="e.g. 3"
                                                   value="{{ old('number_of_featured_listings') }}">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select name="show_at_home" class="form-control">
                                                ...
                                                <option value="yes" @selected(old('show_at_home', 'yes') == 'yes')>Yes</option>
                                                <option value="no" @selected(old('show_at_home') == 'no')>No</option>
                                            </select>
