...
@section('dashboard_title','Update Location')
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select name="show_at_home" class="form-control">
                                                ...
                                                <option value="yes" {{ old('show_at_home',$location->show_at_home) == 'yes' ? 'selected' : '' }}>
                                                    Yes
                                                </option>
                                                <option value="no" {{ old('show_at_home',$location->show_at_home) == 'no' ? 'selected' : '' }}>
                                                    No
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="notes" rows="6" class="form-control"
                                                      placeholder="Enter Location notes">{{ old('notes',$location->notes) }}</textarea>
