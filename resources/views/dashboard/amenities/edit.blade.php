...
@section('dashboard_title','Edit Amenity')
...
@section('content')
    <section class="section">
        ...
        <div class="section-body">
            <h2 class="section-title">Edit Amenity</h2>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select name="status" class="form-control">
                                                ...
                                                <option value="active" @selected(old('status',$amenity->status) == 'active' )>
                                                    Active
                                                </option>
                                                <option value="inactive" @selected(old('status',$amenity->status) == 'inactive' )>
                                                    Inactive
                                                </option>
                                            </select>
