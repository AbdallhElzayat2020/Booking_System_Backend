...
@section('dashboard_title', 'Update Listing')
...
@section('content')
    <section class="section">
        ...
        <div class="section-body">
            <h2 class="section-title">Update Listing</h2>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                @if($listing->image)
                                                    <img src="{{ asset('listings/'.$listing->image) }}" alt="Main Image" class="img-thumbnail mb-2" width="100">
                                                @endif
                                            ...
                                            <div class="col-lg-6">
                                                @if($listing->thumbnail_image)
                                                    <img src="{{ asset('listings/'.$listing->thumbnail_image) }}" alt="Main Image" class="img-thumbnail mb-2" width="100">
                                                @endif
                                                <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="location_id" class="form-control select2">
                                                ...
                                                @foreach($locations as $location)
                                                    <option value="{{ $location->id }}" @selected(old('location_id',$listing->location_id) == $location->id)>
                                                        {{ $location->title }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group">
                                            @if($listing->attachments)
                                                <p>
                                                    ...
                                                    <a href="{{asset('listings/'.$listing->attachments)}}" target="_blank">
                                                        {{$listing->attachments}}
                                                    </a>
                                                </p>
                                            @endif
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" multiple name="amenities[]">
                                                    @foreach($amenities as $amenity)
                                                        ...
                                                        <option value="{{ $amenity->id }}" @selected(in_array($amenity->id, old('amenities', $selectedAmenities)))>
                                                            {{ $amenity->title }}
                                                        </option>
                                                    @endforeach
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select name="is_verified" class="form-control">
                                                <option value="no" @selected(old('is_verified',$listing->is_verified) == 'no')>No</option>
                                                <option value="yes" @selected(old('is_verified',$listing->is_verified) == 'yes')>Yes</option>
                                            </select>
                                            @error('is_verified')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select name="is_featured" class="form-control">
                                                <option value="no" @selected(old('is_featured',$listing->is_featured) == 'no')>No</option>
                                                <option value="yes" @selected(old('is_featured',$listing->is_featured) == 'yes')>Yes</option>
                                            </select>
                                            @error('is_featured')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
