...
@section('title',$category->title.' -   Listings')
                    ...
                    <div class="col-12 text-center text-white">
                        ...
                        <nav style="--bs-breadcrumb-divider: '';" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"> {{$category->title}} - listing</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                ...
                                <a href="{{ route('listing-details',$listing->slug) }}">
                                    <div class="wsus__featured_single">
                                        <div class="wsus__featured_single_img">
                                            <img src="{{asset('listings/'.$listing->thumbnail_image)}}" alt="{{$listing->title}}" class="img-fluid w-100">
                                            <a href="#" class="love"><i class="fas fa-heart"></i></a>
                                            <a href="#" class="small_text">
                                                {{$listing->category->title}}
                                            </a>
                                        </div>
                                        <a class="map" onclick="showListingModal('{{$listing->id}}')" data-bs-toggle="modal" data-bs-target="#exampleModal2" href="#"><i
